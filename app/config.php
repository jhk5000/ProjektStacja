...
$config['pages_groups'] = array(
	...
	'customers'     => array(1,2,3,4), // "studenci" - > klienci
	...
	'mystation'    => array(1), // "myworks" - > mystation (moja stacja, dla kierownika)
	'station'      => array(2,3), // "works" - > station (wszystkie stacje koncernu)
	'discount'   => array(2,3,4), // "mysubjects" -> discount (ustalanie zniżek dla klienta)
